			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.liuyibing.model.Order o=(com.liuyibing.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.liuyibing.dao.UserDao userDao=new com.liuyibing.dao.UserDao();
						...
						<%
							...
							String paymentType=com.liuyibing.model.Payment.findByPaymentId(con,n);
							 %>
